...
import { INDUSTRIES, type IndustryKey } from "./starter-industries";

// Re-exported so existing server-side importers of "@/lib/starter-prompts"
// (e.g. the /api/analyze stream route) keep working unchanged. Client
// components must import these from "@/lib/starter-industries" directly to
// avoid pulling this module's server-only LLM/db graph into the browser.
export { INDUSTRIES, type IndustryKey };
