    ...
    <div className="space-y-6">
      <div className="card p-5">
        ...
        <input
          ...
          className="mt-2 w-full rounded-lg border border-line bg-surface px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent/40"
        />
        ...
        <textarea
          ...
          rows={5}
          className="mt-2 w-full rounded-lg border border-line bg-surface px-3 py-2 text-xs leading-relaxed outline-none focus:ring-2 focus:ring-accent/40"
        />
